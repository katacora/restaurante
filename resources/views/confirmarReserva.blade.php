...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/tailwind.css') }}"> <!-- Ajusta la ruta según tu estructura de proyecto -->
</head>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-md mx-auto p-6 bg-white rounded-md shadow-md">
        ...
        <a href="http://localhost/clase/restaurante/public/reservar" class="bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-600">Ir a Reservar</a>
    </div>
